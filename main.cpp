...
int main(int argc, char** argv) {
    ...
    cout << "PAUL,PROMIT   \t\t  20-42904-1 \t SEC-B" << endl;
    cout << "KHAN,MD MOBIN \t\t  20-42925-1 \t SEC-B" << endl;
    cout << "AHMED,IMTIAZ  \t\t  20-42933-1 \t SEC-B" << endl;

    glutDisplayFunc(start); // Register display callback handler for window re-paint
